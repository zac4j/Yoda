...
@JsonInclude(JsonInclude.Include.NON_NULL) @JsonPropertyOrder({
  ...
  @JsonProperty("textLength") private Integer textLength;
  ...
  @JsonProperty("textLength") public Integer getTextLength() {
    return textLength;
  }

  @JsonProperty("textLength") public void setTextLength(Integer textLength) {
