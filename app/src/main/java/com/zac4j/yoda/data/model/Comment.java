...
@JsonInclude(JsonInclude.Include.NON_NULL) @JsonPropertyOrder({
  ...
  @JsonProperty("source_type") private Integer sourceType;
  ...
  @JsonProperty("floor_number") public Integer getFloorNumber() {
    return floorNumber;
  }

  @JsonProperty("floor_number") public void setFloorNumber(Integer floorNumber) {
  ...
  @JsonProperty("source_allowclick") public Integer getSourceAllowclick() {
    return sourceAllowclick;
  }

  @JsonProperty("source_allowclick") public void setSourceAllowclick(Integer sourceAllowclick) {
    this.sourceAllowclick = sourceAllowclick;
  }

  @JsonProperty("source_type") public Integer getSourceType() {
    return sourceType;
  }

  @JsonProperty("source_type") public void setSourceType(Integer sourceType) {
  ...
  @JsonProperty("status") public Weibo getWeibo() {
    return weibo;
  }

  @JsonProperty("status") public void setWeibo(Weibo weibo) {
    this.weibo = weibo;
  }
  ...
  @JsonProperty("url_objects") public List<Object> getUrlObjects() {
    return urlObjects;
  }

  @JsonProperty("url_objects") public void setUrlObjects(List<Object> urlObjects) {
    this.urlObjects = urlObjects;
  }

  @JsonProperty("liked") public Boolean getLiked() {
    return liked;
  }

  @JsonProperty("liked") public void setLiked(Boolean liked) {
    this.liked = liked;
  }
