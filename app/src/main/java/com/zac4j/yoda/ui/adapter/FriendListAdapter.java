...
public class FriendListAdapter
    ...
    @Inject
    public FriendListAdapter(@ActivityContext Context context) {
        mContext = context;
    ...
    static class FriendListViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.user_friend_list_iv_avatar)
        ImageView mAvatarView;
        @BindView(R.id.user_friends_list_tv_nickname)
        TextView mNicknameView;
        @BindView(R.id.user_friends_list_tv_description)
