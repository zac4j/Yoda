...
public class UserFragment extends BaseFragment implements UserView {
    ...
    View mMainView;
    @BindView(R.id.user_detail_iv_cover)
    ImageView mCoverView;
    @BindView(R.id.user_detail_iv_avatar)
    ...
    TextView mLinkView;
    @BindView(R.id.user_detail_tv_follower_count)
    TextView mFollowerCountView;
    @BindView(R.id.user_detail_tv_following_count)
    TextView mFollowingCountView;
    @BindView(R.id.user_detail_swc_night_mode)
    Switch mNightModeSwitch;
    @BindView(R.id.user_detail_swc_data_saver)
    Switch mDataSaverSwitch;
    ...
    private void showNicknameAndGender(String nickname, String gender) {
        ...
        if (TextUtils.equals(gender, "f")) {
            mNicknameView.setCompoundDrawablesWithIntrinsicBounds(0, 0, R.drawable.ic_user_female,
                0);
        } else {
