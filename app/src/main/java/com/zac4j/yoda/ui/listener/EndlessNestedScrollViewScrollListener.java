package com.zac4j.yoda.ui.listener;
...
public abstract class EndlessNestedScrollViewScrollListener implements NestedScrollView.OnScrollChangeListener{
    ...
    public EndlessNestedScrollViewScrollListener(LinearLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
    }

    public EndlessNestedScrollViewScrollListener(GridLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }

    public EndlessNestedScrollViewScrollListener(StaggeredGridLayoutManager layoutManager) {
        this.mLayoutManager = layoutManager;
        visibleThreshold = visibleThreshold * layoutManager.getSpanCount();
    }
    ...
    @Override
    public void onScrollChange(NestedScrollView view, int scrollX, int scrollY, int oldScrollX,
        int oldScrollY) {
