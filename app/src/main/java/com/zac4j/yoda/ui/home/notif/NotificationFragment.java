...
public class NotificationFragment extends BaseFragment implements NotificationView {
    ...
    @BindView(R.id.home_notif_tv_at_me_count)
    TextView mAtMeCountView;
    @BindView(R.id.home_notif_rv_comment_list)
    ...
    @Override
    public void showEmptyFollower() {
        mAtMeCountView.setText(R.string.notif_no_latest_follows);
    }

    @Override
    public void showLatestFollowers(List<User> users) {
