...
public class WeiboRepostDialogFragment extends BaseDialogFragment implements WeiboRepostView {
    ...
    @Inject
    WeiboRepostPresenter mPresenter;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        TextInputEditText contentInput = view.findViewById(R.id.weibo_repost_dialog_et_comment);
        CheckBox asComment = view.findViewById(R.id.weibo_repost_dialog_ckb_as_content);
