...
import com.zac4j.yoda.util.image.EmojiTransformation;
...
public class WeiboImageLoader {
    ...
    public static void loadEmoji(TextView textView, String emojiUrl, SpannableString spannableString,
        int startIndex, int endIndex) {
        GlideApp.with(textView.getContext())
            .load(emojiUrl)
            .transform(new EmojiTransformation())
